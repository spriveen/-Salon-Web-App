    ...
    <div className=" py-12 flex flex-col items-center text-center">
      ...
      <div className="flex flex-wrap gap-6 items-center justify-center">
        {teamData.map((item, index) => (
          <div
            key={index}
            className="group flex flex-col items-center py-8 text-sm bg-white border border-gray-300/60 w-64 rounded-md cursor-pointer hover:border-primary hover:bg-primary transition"
          >
            <img
